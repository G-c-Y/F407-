...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "sensor_anomaly_model"
...
#define AI_NETWORK_IN_1_CHANNEL     (8)
#define AI_NETWORK_IN_1_SIZE        (8)
...
#define AI_NETWORK_OUT_1_SIZE_BYTES  (3)
